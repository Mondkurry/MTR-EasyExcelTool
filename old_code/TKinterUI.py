...
class MTR_EasyExcel_Tool(tk.Tk):
    ...
    def __init__(self):
        ...
        self.Title = customtkinter.CTkLabel(self, text="MTR EasyExcel Tool",font=("Arial", 36, "bold"),
                                            ...
                                            padx=10,
                                            pady=10,)
        self.Title.grid(row=0, column=5, pady=10,
                        padx=10, rowspan=4, columnspan=12)
        ...
        self.Pick_col_section = customtkinter.CTkLabel(self,
                                                       ...
                                                       pady=10,
                                                       anchor="n")
        self.Pick_col_section.grid(
            row=4, column=4,  pady=10, padx=10, rowspan=8, columnspan=12)
        ...
        self.File_Preview = customtkinter.CTkLabel(self,
                                                   ...
                                                   pady=10,
                                                   anchor="n")
        self.File_Preview.grid(row=12, column=0,  pady=10,
                               padx=10,  rowspan=4, columnspan=16)
        ...
        self.File_Preview = customtkinter.CTkLabel(self,
                                                   ...
                                                   pady=10,
                                                   anchor="n")
        self.File_Preview.grid(row=16, column=0,  pady=10,
                               padx=10, rowspan=4, columnspan=16)
    ...
    # --------------------------------------------------------------------------#
        ...
        self.importButtonInstructions = customtkinter.CTkLabel(self,
                                                               ...
                                                               pady=10,
                                                               anchor="n")
        self.importButtonInstructions.grid(
            row=0, column=0,  pady=10, padx=10, rowspan=6, columnspan=4)
    ...
    def open_file(self):
        ...
        self.confirm_sheet_name_button.grid(
            row=7, column=0,  pady=0, padx=25, sticky="n")
    ...
    def get_num_col(self):
        self.number_col = len(populate_array_from_excel(
            self.get_file_path(), self.get_sheet_name())[1])
        print(self.number_col)
    ...
    def make_columns(self):
        for i in range(self.get_num_col()):
            ...
            self.checkBox.grid(row=4, column=(
                5+i), pady=10, padx=10, sticky="s")
        print(self.number_col)
